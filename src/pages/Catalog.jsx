...
import { 
  Search, Filter, Grid, List, ChevronDown, Package,
  Download, Eye, Plus, Minus, Image
} from 'lucide-react';
...
const series = {
  ...
  modular: [
    { name: 'Millanta модульная', desc: 'До 7 модулей в рамке', colors: ['Белый', 'Крем', 'Серый'] },
...
export default function Catalog() {
  ...
  const currentSeries = series[activeCategory] || [];

  const openProductModal = (product) => {
    // Добавляем изображение из состояния, если оно есть
