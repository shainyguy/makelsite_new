    ...
    <div ref={containerRef} className="overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <motion.div style={{ y }} className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1920&q=80')] bg-cover bg-center opacity-20 mix-blend-overlay" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative">
                <div className="w-full aspect-square bg-white/10 backdrop-blur-md rounded-3xl border-2 border-white/20 flex items-center justify-center overflow-hidden">
                  <img 
                ...
                {/* Floating Badge */}
                <div className="absolute -bottom-4 -left-4 bg-white text-red-600 px-6 py-3 rounded-xl shadow-xl font-bold">
                  1300+ товаров
                </div>
              </div>
            </motion.div>
